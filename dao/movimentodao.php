...
{
    public function RealizarMovimento($tipo, $data, $valor, $categoria, $empresa, $conta, $observacao)
    {
        if (trim($tipo) == '' || trim($data) == '' || trim(is_numeric($valor)) == '' || trim($categoria) == '' || trim($empresa) == '' || trim($conta) == '')
            return 0;
    ...
    public function ValidarData($data_inicial, $data_final)
    {
