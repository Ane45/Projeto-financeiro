            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5>Consulte todos os seus movimentos em um determinado período. </h5>
                ...
                <form action="consultar_movimento.php" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="divdatainicial">
                            ...
                            <input type="date" class="form-control" placeholder="Coloque a data do movimento" id="datainicial" name="data_inicial" value="<?= $data_inicial ?>" />
                        </div>
                    </div>
                    <div class="col-md-6" id="divdatafinal">
                        <div class="form-group">
                            <label>Data final*</label>
                            <input type="date" class="form-control" placeholder="Coloque a data do movimento" id="datafinal" name="data_final" value="<?= $data_final ?>" />
                        </div>
                    </div>
                    <center>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <b> Tipo do movimento: </b>Tipo do Movimento: <?= $movs[$i]['tipo_movimento'] == 1 ? 'Entrada' : 'Saída' ?> <br>
                                                                                <b> Categoria: </b> <?= $movs[$i]['nome_categoria'] ?> <br>
                                                                                <b> Empresa: </b> <?= $movs[$i]['nome_empresa'] ?> <br>
                                                                                <b> Conta: </b> <?= $movs[$i]['banco_conta'] ?> / Agência: <?= $movs[$i]['agencia_conta'] ?> - Número: <?= $movs[$i]['numero_conta'] ?> <br>
